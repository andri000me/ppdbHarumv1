    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('<?= base_url('vendor/loginv4/') ?>images/bg-01.jpg');">
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="<?php echo base_url('index.php/auth/aksi_login'); ?>" method="post">
                    ...
                    <!-- <div class="text-right p-t-8 p-b-31">
                        <a href="<?= base_url('vendor/loginv4/') ?>#">
                            Forgot password?
                        </a>
                    </div> -->
                    <hr>
                    ...
                    <div class="flex-c-m">
                        <a href="<?= base_url('vendor/loginv4/') ?>#" class="login100-social-item bg1">
                            <i class="fa fa-facebook"></i>
                        </a>

                        <a href="<?= base_url('vendor/loginv4/') ?>#" class="login100-social-item bg2">
                            <i class="fa fa-twitter"></i>
                        </a>

                        <a href="<?= base_url('vendor/loginv4/') ?>#" class="login100-social-item bg3">
                    ...
                    <div class="flex-col-c p-t-155">
                        ...
                        <a href="<?= base_url('vendor/loginv4/') ?>#" class="txt2">
                            Sign Up
                        </a>
                    </div> -->
                </form>
